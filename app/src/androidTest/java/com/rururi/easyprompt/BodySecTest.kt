...
class BodySecTest {
    ...
    fun setUp() {
        composeTestRule.setContent {
            ...
            BodySec(viewModel = vm, uiState = uiState)
        }
    }
    ...
    @Test
    fun showsTextFields() {
        composeTestRule.onNodeWithText("■" + composeTestRule.activity.getString(R.string.body_text_title)).assertExists()
        composeTestRule.onNode(hasText(composeTestRule.activity.getString(R.string.body_text))).assertExists()
    }

    //タイトルのフォントのラジオボタンが表示されるか
    @Test
    fun showsFamilyOption() {
        composeTestRule.onNodeWithText("■" + composeTestRule.activity.getString(R.string.body_family_title)).assertExists()
    ...
    @Test
    fun showsSizeOption() {
        composeTestRule.onNodeWithText("■" + composeTestRule.activity.getString(R.string.body_size_title)).assertExists()
    ...
    fun showsWeightOption() {
        composeTestRule.onNodeWithText("■" + composeTestRule.activity.getString(R.string.body_weight_title)).assertExists()
    ...
    fun showsColorOption() {
        composeTestRule.onNodeWithText("■" + composeTestRule.activity.getString(R.string.body_color_title)).assertExists()
    ...
    @Test
    fun showsXposOption() {
        composeTestRule.onNodeWithText("■" + composeTestRule.activity.getString(R.string.body_xpos_title)).assertExists()
    ...
    @Test
    fun showsYposOption() {
        composeTestRule.onNodeWithText("■" + composeTestRule.activity.getString(R.string.body_ypos_title)).assertExists()
    ...
    fun showsHeightOption() {
        composeTestRule.onNodeWithText("■" + composeTestRule.activity.getString(R.string.body_height_title))
            .assertExists()
    ...
    fun showsSpacingOption() {
        composeTestRule.onNodeWithText("■" + composeTestRule.activity.getString(R.string.body_spacing_title))
            .assertExists()
    ...
    fun updatesXposWhenOptionSelected() {
        ...
        composeTestRule.runOnIdle {
            val selected = viewModel.uiState.value.bodyState.xPos     //uiStateの値を取得
